...
router.register(r'feedback', views.InterviewFeedbackViewSet, basename='interview-feedback')
router.register(r'observations', views.ObservationSheetViewSet, basename='observation-sheet')
